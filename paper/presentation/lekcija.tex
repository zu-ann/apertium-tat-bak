...
\begin{tabular}{cc}
 ...
 Dept. Lleng. i Sist. Inform. & Depts. Linguistics \&\\
 Universitat d'Alacant & Central Eurasian Studies \\
  & Indiana University \\
...
\begin{frame}
  ...
  \begin{onlyenv}<2>
	...
	\begin{block}{Tatar and Bashkir}
		\begin{itemize}
			\item[tat] Һава бүген бик әйбәт, җылы гына.  \\
			{\qipa [hɑwɑ bɵɣɘn bijk æjbæt, ʑələ ʁənɑ]}
			\item[bak] Һауа бөгөн бик әйбәт, йылы ғына. \\
	...
	\begin{block}{Comparison with other Turkic languages}
		\begin{itemize}
			\item[tur] Hava bugün çok güzel, yeterince sıcak. \\
			{\qipa [hɑvɑ buɣyn ʧok gyzæl, jɛtʰɛrɪnʤɛ sɯʤɑkʰ]}
			\item[chv] Ҫанталӑк паян питӗ хитре, самай ӑшӑ. \\
			{\qipa [ɕanˈtalək pɑˈjɑn ˈpitɘ xitˈre, saˈmaj ˈɔʂə]}
			\item[kaz] Ауа райы бүгін әбден жақсы, жылы. \\
			{\qipa [ɑwɑ ɾɑjə bʉɣɘn æbdi̯ɘn ʐɑχsə, ʐələ]}
			\item[kir] Аба ырайы бүгүн аябай жакшы, жылуу. \\
...
\begin{center}
  \includegraphics[width=0.82\textwidth]{apertiumlangs1.pdf}%FIXED: svg->pdf is ugly
\end{center}
