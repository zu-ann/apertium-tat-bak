...
\begin{center}
\includegraphics[width=0.82\textwidth]{apertiumlangs.pdf}
\end{center}
...
\begin{block}{Other Turkic language projects:}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Tatar$\leftrightarrow$Kazakh$\dagger$
      \item Turkish$\leftrightarrow$Turkmen$\dagger$
      \item Turkish$\leftrightarrow$Tatar$\dagger$
    \end{itemize}
  \end{itemize}
    $\dagger$ As projects in the 2012 Google Summer of Code.
\end{block}
